...
function ModalFilter({resetFilter, catID, filterByPrice, itens}) {
  return (
    <>
      <div
        ...
        <div className="modal-dialog modal-lg modal-dialog-centered modal-dialog-scrollable">
          <div className="modal-content">
            <div className="modal-header text-center">
              ...
              ></button>
              <h1
                className="modal-title w-100 fs-5 fw-bold"
            ...
            <div className="modal-body">
              <section className="px-2 mb-4 border-bottom">
                <span className="f4-bold">Faixa de Preço</span>
                <p className="text-muted">
                  O preço médio por noite é de R$730,00
                </p>
                ...
                <div className="row mt-4">
                  <div className="col-md-6 mb-4">
                    <div className="form-check ms-3 px-4">
                      ...
                      <label
                        ...
                        htmlFor="espacoInteiro"
                      >
                        Espaço Inteiro <br></br>
                  ...
                  <div className="col-md-6 mb-4">
                    <div className="form-check ms-3">
                      ...
                      <label
                        className="ps-2 form-check-label"
                        htmlFor="quartoInteiro"
                      >
                        Quarto Inteiro <br></br>
                        <small className="text-muted">
                          {" "}
                          Seu próprio quarto em uma casa ou hotel, além de
                          alguns espaços comuns compartilhados
                        </small>
                      </label>
                    </div>
                  </div>
                  <div className="col-md-6 mb-5">
                    <div className="form-check ms-3">
                      <input
                        ...
                        type="checkbox"
                        value=""
                        id="quartoCompartilhado"
                      />
                      <label
                        className="ps-2 form-check-label"
                        htmlFor="quartoCompartilhado"
                      >
                        Quarto Compartilhado <br></br>
                        <small className="text-muted">
                          {" "}
                          Um espaço para dormir e áreas comuns que podem ser
            ...
            <div className="d-flex justify-content-between modal-footer">
              <a href="#" onClick={() => {resetFilter(catID)}} className=" ps-2 link-dark fw-bold" data-bs-dismiss="modal">
                Remover Filtros
              </a>
              <button
                type="button"
                ...
                data-bs-dismiss="modal"
              >
                Mostrar {itens.length} acomodações
              </button>
            </div>
          </div>
        </div>
